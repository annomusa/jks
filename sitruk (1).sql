...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 07, 2015 at 04:07 PM
...
INSERT INTO `karyawan` (`ID_KARYAWAN`, `NAMA`, `NO_HP`, `ALAMAT`, `TGL_MASUK_KERJA`, `PENEMPATAN`, `STATUS`) VALUES
(1, 'Badrun', '081232119087', 'Jl. Wonorejo 2, Surabaya', '2015-08-05', 'Lapangan', 'Supir');
...
INSERT INTO `ongkos` (`ID_ONGKOS`, `ID_SATUAN`, `TUJUAN`, `HARGA`) VALUES
(1, 1, 'Pasir Ketapang', 2600),
(2, 1, 'Pasir Klampis', 2200);
...
INSERT INTO `perjalanan` (`ID_PERJALANAN`, `ID_PENERBIT`, `ID_ONGKOS`, `ID_KENDARAAN`, `TGL_PERJALANAN`, `NO_SURAT_PO`, `JENIS_PERINTAH`, `RITASE`, `TITIPAN_AWAL`, `LEBIH`, `KURANG`, `AKHIR`, `STATUS`) VALUES
(4, 1, 0, 1, '2015-08-31', 'PO 001', 'Langsung', '', NULL, NULL, NULL, NULL, 'BARU');
...
--
ALTER TABLE `relasi_po`
MODIFY `ID_RELASI_PO` int(11) NOT NULL AUTO_INCREMENT;
--
